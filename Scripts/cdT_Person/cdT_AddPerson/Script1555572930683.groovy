...
def checkPersonKo = WS.sendRequest(findTestObject('PersonsOR/GetOnePerson'))
WS.verifyResponseStatusCode(checkPersonKo, 404)

//Ajoute une personne lamda (dans notre cas, la personne ne nomme Jean) et vérifie qu'il retourne bien le code 200
//gender, name, birthDate in args request2
...
//Verifie si la personne a bien été ajoutée dans la liste de personne (i+1) et retourne bien le code 200
...
//Vérifie que la personne n'existe plus dans la liste de personne et retourne bien le code erreur 404
def checkPersonKoAgain = WS.sendRequest(findTestObject('PersonsOR/GetOnePerson'))
WS.verifyResponseStatusCode(checkPersonKoAgain, 404)
